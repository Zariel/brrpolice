...
fn adr_0006_candidate_profiles() -> Vec<CandidateProfile> {
    vec![
        ...
        CandidateProfile {
            model: ReplayScoreModel::RatePrimaryCurvedShoulder,
        },
        CandidateProfile {
            model: ReplayScoreModel::RatePrimaryThresholdedAccumulation,
        },
        CandidateProfile {
            model: ReplayScoreModel::RatePrimaryPersistentWatch,
        },
        CandidateProfile {
        ...
        CandidateProfile {
            model: ReplayScoreModel::RatePrimaryGatedLongResidency,
        },
        CandidateProfile {
